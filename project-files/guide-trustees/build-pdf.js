...
const STEPS = [
  {
    ...
    p: [
      'הקישור פותח את מסך הכניסה של המערכת. אתם <b>לא</b> צריכים שם משתמש וסיסמה.',
      'לוחצים על הכפתור התחתון — <b>«🦺 דיווח נאמני בטיחות (ללא סיסמה)»</b>.',
    ],
  },
  {
    img: '02-name.png', n: 2,
    ...
    p: [
      'פותחים את הרשימה <b>«השם שלי»</b> ובוחרים את עצמכם. הטלפון זוכר — בפעם הבאה תיכנסו ישר למסך שלכם.',
  ...
  },
  {
    ...
    p: [
      ...
      'מתחת — רשימת המשימות של החודש. כל משימה פעם אחת בחודש, בזמן שנוח לכם.',
    ],
    quiet: true,
  },
  {
  ...
  },
  {
    ...
    p: [
      ...
      'התאריך ממולא אוטומטית להיום — אפשר לשנות אותו אם הסיור היה אתמול.',
  ...
  },
  {
    ...
    p: [
      'הכל תקין → <b>«✅ תקין»</b>, ושולחים.',
      'משהו לא תקין → <b>«⚠️ ליקוי»</b>, כותבים מה הליקוי, ו<b>מצלמים</b>. בלי תמונה המערכת לא תשלח — התמונה היא מה שמאפשר לתקן בלי לחזור לשאול איפה ומה.',
      'מצאתם עוד משהו באותה משימה? <b>«+ עוד עמדה / מפגע באותה משימה»</b> — לא צריך למלא טופס חדש.',
      'ובסוף — <b>«שלח דיווח»</b>.',
    ],
  },
  {
    ...
    p: [
      'הדיווחים שלכם מופיעים ב־<b>«📝 הדיווחים שלי החודש»</b>. <b>תקין</b> ירוק = נסגר. <b>פתוח</b> אדום = הליקוי עדיין ממתין לטיפול.',
      'אחרי שתוקן — <b>«📷 צלם אחרי»</b>, מצלמים את המצב החדש, והמפגע נסגר. זה גם מה שמזכה אתכם בשתי הנקודות.',
...
<ul>
  ...
  <li><b>+2 נקודות</b> לכל מפגע שדיווחתם עליו <b>ונסגר</b> — עד 20 נקודות.</li>
...
<p>בתחתית המסך: <b>«⛔ דווח כמעט ונפגע»</b>. אירוע שכמעט הסתיים ברע — מעידה שנמנעה,
עומס שכמעט נפל, רכב שכמעט פגע. אלה הדיווחים שמונעים את התאונה הבאה, וגם עליהם מדווחים כאן.</p>
...
<div class="hd">
  ...
  <p>תעשיות תפוגן בע"מ · בלי סיסמה, בלי התקנה</p>
</div>
<div class="body">
  <div class="url">${LINK}</div>
  <p class="note">פותחים פעם אחת → «הוסף למסך הבית» → יש לכם אייקון בטלפון</p>
  <ol>
    <li>לוחצים על <b>«🦺 דיווח נאמני בטיחות (ללא סיסמה)»</b></li>
  ...
  <div class="score">
    <b>ניקוד:</b> 10 לכל משימה · +2 לכל מפגע שנסגר (עד 20) · מ־5 משימות בחודש — מועמדות לפרס
  </div>
</div>
</html>`;
