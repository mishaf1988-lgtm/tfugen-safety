...
const STEPS = [
  ...
  },
  {
    ...
    h: 'מזינים את הקוד, פעם אחת',
    p: [
      'יופיע מסך <b>"כניסת נאמני בטיחות"</b> עם שדה אחד. מקלידים את הקוד שקיבלתם מממונה הבטיחות ולוחצים <b>"כניסה"</b>.',
      '<b>הטלפון זוכר אותו</b>, ובפעמים הבאות תיכנסו ישר. הקוד לא נמצא במדריך הזה בכוונה: אתם מקבלים אותו בהודעה נפרדת.',
...
<div class="body">
  ...
  <ol>
    <li>לוחצים על <b>"🦺 דיווח נאמני בטיחות"</b>, ומקלידים את <b>הקוד</b> שקיבלתם. פעם אחת, הטלפון זוכר</li>
