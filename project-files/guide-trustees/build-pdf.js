...
const STEPS = [
  ...
  },
  {
    ...
    p: [
      ...
      '<b>מתחת לשדה הקוד יש תיבה: "זכור אותי במכשיר הזה".</b> אם מסמנים אותה, הטלפון זוכר את הקוד ובפעם הבאה נכנסים ישר. אם לא מסמנים, הקוד נדרש בכל פתיחה. בכל מקרה שמרו את הקוד במקום שנוח להגיע אליו: הוא לא נמצא באפליקציה.',
