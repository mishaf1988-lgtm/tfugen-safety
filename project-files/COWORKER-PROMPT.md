# פרומפט מוכן ל-Coworker

> **איך להשתמש:** העתיקי את כל הטקסט שבתוך הבלוק האפור למטה (החל מ-"שלום Coworker" ועד הסוף), הדביקי ל-Coworker, ושלחי. הוא יבצע את הכל וידווח לך כשסיים.
...
## 🔄 מה אני אעשה אחרי שCoworker יסיים

ברגע שCoworker יאשר שההרשאה נוספה, אני אעשה את הצעדים הבאים בעצמי באפליקציה:
...
## 💡 טיפ למקרה שCoworker מתבלבל

אם Coworker שואל "איזה אפליקציה?" או מתקשה למצוא אותה — תני לו את ה-Client ID:
...
4. העתיקי את המספר ושלחי לCoworker — הוא ימצא את האפליקציה לפי המספר הזה
