...
**אלטרנטיבות שנדחו**: סנכרון דו-כיווני (Vitre לא מובילה, אין טעם לכתוב אליה); ייבוא היסטוריית משימות Vitre כארכיון (אפשרי בעתיד אם יידרש לביקורת, לא עכשיו); Vitre כערוץ התראות (עקיף, לא מתועד, ולא הבעיה: אחרי סנכרון עובדים יש לנו טלפונים ומיילים לוואטסאפ/מייל הקיימים).
