...
## 2026-09-25 — נעילת האפליקציה: ברירת מחדל 12 שעות במקום «בכל פתיחה», כי הדו-שלבי חובה לכולם
**החלטה**: `_LOCK_DEFAULT_MIN=720`. טלפון שלא בחר הגדרה נכנס ישר אם השתמשו בו ב-12 השעות האחרונות, ומתבקש סיסמה + קוד אחרי חצי יום. «בכל פתיחה» (-1) נשאר אפשרות בהגדרות, לכל מכשיר, לאדמין. הקיוסק של הנאמנים לא מושפע (מדיניות הקוד שלו בשרת, `TRUSTEE_REMEMBER`).
