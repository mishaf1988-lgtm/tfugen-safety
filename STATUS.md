...
**Last updated**: 2026-09-18 (HEAD = PR #550 — סבב handoffs 2026-09-18: 16 PRs #535-#550. תיקוני P0 (סיורים/NCR/התראות/sync/view), RLS initPlan, בית מנוקה, ניווט iPhone בלי bnav, ווידג׳ט פג-תוקף EQI, קיבוץ מודולים, תפריט ⋯ בדף ציוד, Roles Phase B, תפריטי ⋯ לשורה. ראה סעיף "סשן 2026-09-18" למטה)
...
- [ ] **תוכנית שדרוגים 2026-09-18** — PR-5 C2 (DECISIONS) · PR-6 B2 (Agents) · PR-7 B1 (Investigation Agent) · PR-8 B3 (NCR Agent) · PR-9 C1 (PDF) · PR-10 E1+E2 · PR-11 E3.
