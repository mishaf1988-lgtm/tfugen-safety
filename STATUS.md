...
**📋 רשימת השדרוגים המלאה**: `project-files/BACKLOG-2026-09-20.md` — **75 פריטים** מסודרים לפי תחום, עם חומרה, מאמץ, וסימון מה אומת בקוד מול מה לא. נבנתה מ-6 קוראים (69 פערים) ו-5 מציעים (52 הצעות); שלבי המיזוג והשיפוט האוטומטיים לא רצו (נגמרו קרדיטים) ונעשו ידנית.
