...
**Last updated**: 2026-09-18 (HEAD = PR #564 — סבב handoffs 2026-09-18: 30 PRs #535-#564 + נאמני בטיחות T1+T2+T3 (MVP שלם) + בית העובד = נאמן בלבד + כניסה "דיווח נאמני בטיחות" + רשימת נאמנים. תיקוני P0 (סיורים/NCR/התראות/sync/view), RLS initPlan, בית מנוקה, ניווט iPhone בלי bnav, ווידג׳ט פג-תוקף EQI, קיבוץ מודולים, תפריט ⋯ בדף ציוד, Roles Phase B, תפריטי ⋯ לשורה. ראה סעיף "סשן 2026-09-18" למטה)
