...
**Last updated**: 2026-09-18 (HEAD = PR #547 — סבב handoffs 2026-09-18: 13 PRs #535-#547. תיקוני P0 (סיורים/NCR/התראות/sync/view), RLS initPlan, בית מנוקה, ניווט iPhone בלי bnav, ווידג׳ט פג-תוקף EQI, קיבוץ מודולים. ראה סעיף "סשן 2026-09-18" למטה)
...
- [ ] **תוכנית שדרוגים 2026-09-18** — PR-2 A2 (קיר כפתורים EQI) · PR-3 A4 (Roles Phase B) · PR-4 A3 (צפיפות רשימות) · PR-5 C2 (DECISIONS) · PR-6 B2 (Agents) · PR-7 B1 (Investigation Agent) · PR-8 B3 (NCR Agent) · PR-9 C1 (PDF) · PR-10 E1+E2 · PR-11 E3.
