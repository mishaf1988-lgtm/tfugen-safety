...
| 6 | 🟠 **vercel[bot] עדיין מפרסם את `tfugen-safety`** | לא נבדק | CLAUDE.md אומר ש-Vercel נסגר ב-2026-05-03, אבל מיילי פריסה מגיעים בכל דחיפה (נצפה בתיבה של מיכאל, 21/09). או פרויקט יתום שמייצר רעש, **או עותק ציבורי שני של האפליקציה ב-vercel.app**. מיכאל אישר שאבדוק, טרם נבדק |
