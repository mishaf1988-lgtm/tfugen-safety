...
**Last updated**: 2026-05-04 (Performance Phase 0+1+2+3+4+5(3/5)+6 shipped · 21 PRs · web-vitals · debounce · memoize · Cache-Control · SSE keepalive · Storage cacheControl · RLS perf wrap (initPlan) · poll 2→10min · per-page render-skip · rAF debounce realtime · hourly SW update + soft pill · **SW auto-version via CF Pages function** · **WhatsApp restored end-to-end after Meta App Switch-to-Live** · plan in project-files/PERFORMANCE-PLAN-2026-05-04.md)
